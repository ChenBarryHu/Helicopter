...
import com.shichen.android.flyingfish.GameCharacter.BonusCommander;
import com.shichen.android.flyingfish.GameCharacter.Explosion;
import com.shichen.android.flyingfish.GameCharacter.Fish;
import com.shichen.android.flyingfish.GameCharacter.MonsterCommander;
import com.shichen.android.flyingfish.GameCharacter.PuffCommander;
...
//    Future longRunningTaskFuture;
    ...
    static public boolean newGameWellPrepared = true;
    ...
    public void drawText(Canvas canvas)
    {
        ...
        if(gravityInverseMode){
            ...
            canvas.drawText("Inverse Gravity Mode remaining: " +bonusCommander.gravityInverseCount+" s", WIDTH/2-400, 103, colorpaint);
            canvas.drawText("TRIPLE BONUS!!!!! ", WIDTH/2-200, 500, colorpaint);
        }
        if(unstoppableMode){
            colorpaint.setColor(Color.WHITE);
            canvas.drawText("UNSTOPPABLE", WIDTH/2-200, 103, colorpaint);
